...
git clone -b "linux-msft-wsl-6.6.y" --single-branch --depth=1 https://github.com/microsoft/WSL2-Linux-Kernel.git kernel
...
curl -fsSL https://raw.githubusercontent.com/CachyOS/kernel-patches/refs/heads/master/6.6/all/0001-cachyos-base-all.patch \
  -o patches/0001-cachyos-base-all.patch

curl -fsSL https://raw.githubusercontent.com/CachyOS/kernel-patches/refs/heads/master/6.6/misc/0001-clang-polly.patch \
  -o patches/0002-clang-polly.patch

curl -fsSL https://raw.githubusercontent.com/CachyOS/kernel-patches/refs/heads/master/6.6/sched/0001-bore-cachy.patch \
